...
class DepositController extends Controller
{
    ...
    {   
        ...
        return view('wallet.deposit', compact('wallets'));
    }
    ...
    public function list()
    {
        ...
        return view('wallet.deposit-list', compact('list', 'has_more', 'limit'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {       
            ...
            if($asset->balance < $validated['amount']) {
                throw new \Exception('입금 실패하였습니다. 보유자산의 잔액을 확인하시길 바랍니다.');
            }

            $amount = $validated['amount'];
            $fee_rate = $wallet->deposit_fee_rate;
            ...
            $wallet->increment('balance', $actual_amount);

            DB::commit();
        
            return response()->json([
                'status' => 'success',
                'message' => '입금 성공하였습니다. 재테크 월렛에서 확인하시길 바랍니다.',
                'url' => route('home'),
            ]);
