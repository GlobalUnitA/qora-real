    ...
    <div class="py-3">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form method="POST" id="ajaxForm" action = "{{ route('device.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="uploadBox" class="position-relative bg-light rounded p-4 text-center mb-4">
                        ...
                        <div id="defaultContent">
                            ...
                            {{ __('messages.etc.purchase_upload') }}
                            </p>
                    ...
                    <div class="mb-3">
                        <label class="form-label small">{{ __('messages.purchase.usdt_address') }}</label>
